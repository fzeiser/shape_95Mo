...
const int g_nEvent = 5.e4; // number of events per realization (and ExI in bExSpread)
...
const int g_anDRTSC[] = {2, 6, 11, 13, 16, 21}; // 144Nd
const int g_nEgBin = 500;

////////////////////// Discrete Settings ///////////////////////////////////////
//#define bPrintLvl // print both discrete and constructed lvl schemes
const int g_nZ = 42; // proton number
const int g_nAMass = 95; // proton + neutron number
const int g_nDisLvlMax = 22; // only trust level scheme to here, sets ECrit
const bool g_bIsEvenA = !(g_nAMass % 2);
const int g_nDisLvlGamMax = 12; // max gammas in for a discrete lvl
...
int g_nConEBin;
#endif // bForceBinNum
const int g_nConSpbMax = 20; // constructed # spin(s) (#bins = +1); can choose small for light ion rxn
...
const double g_dExIMax = 7.5; // MeV; constructed lvl scheme built up to this
// dont exceed with init excitations - gaus might sample higher than expected
const double g_adExIMean[] = {1.6, 1.8, 2., 2.2, 2.4,
       2.6, 2.8, 3. , 3.2, 3.4, 3.6, 3.8, 4. , 4.2, 4.4, 4.6, 4.8, 5. ,
       5.2, 5.4, 5.6, 5.8, 6. , 6.2, 6.4, 6.6, 6.8, 7.}; // MeV
...
const int g_nExPopI = 81; // bins 0-81; bins + maxlevelstar + 1 = g_nExPopI
const int g_nSpPopIBin = 20; // spins 0-29
...
#endif
#ifdef bExFullRxn
const double g_adExIMean[] = {1.6, 1.8, 2.0, 2.2, 2.4, 2.6, 2.8, 3.0, 3.2}; // unsed in full rxn
